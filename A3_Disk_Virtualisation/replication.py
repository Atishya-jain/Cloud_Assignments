...
def Testing():
	...
	print("---------------Initial Unalloted Blocks-----------------")
	print([(j.starting_block, j.num_blocks) for j in global_fragments_list])
	print("-------Creating a new disk with size 200 blocks---------")
	create_disk(0,200)
	print("----------Unalloted Blocks after disk creation----------")
	print([(j.starting_block, j.num_blocks) for j in global_fragments_list])
	print("-------------------Write(0, Atishya Jain)---------------")
	write_block(0,0,"Atishya Jain")
	print("-------------------Write(99, Mankaran Singh)------------")
	write_block(0,99,"Mankaran Singh")
	print("-------------------Write(199, Mayank Singh)-------------")
	write_block(0,199,"Mayank Singh Chauhan")
	print("----------------------Reading(0)------------------------")
	print(read_block(0,0))
	print("----------------------Reading(99)-----------------------")
	print(read_block(0,99))
	print("----------------------Reading(199)----------------------")
	print(read_block(0,199))
	print("-------------------Deleting the disk--------------------")
	delete_disk(0)
	print("----------Unalloted Blocks after disk deletion----------")
	print([(j.starting_block, j.num_blocks) for j in global_fragments_list])
	print("-------Creating a new disk with size 200 blocks---------")
	create_disk(1,200)
	print("----------Unalloted Blocks after disk creation----------")
